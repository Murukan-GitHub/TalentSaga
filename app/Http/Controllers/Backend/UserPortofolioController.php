...
class UserPortofolioController extends BackendController
{
    /**
     * Override Default Constructor.
     *
     * @param UserPortofolioRepository $_baseRepo
     * @param UserPortofolio           $_baseModel
     */
    public function __construct(UserPortofolioRepository $_baseRepo, UserPortofolio $_baseModel)
    {
        parent::__construct($_baseRepo, $_baseModel, 'user');
        $this->routeBaseName = 'backend.userportofolio';
        $this->viewBaseClosure = 'backend.userportofolios';
