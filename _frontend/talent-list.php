                    ...
                    <div class="container">
                        <figure class="category-header">
                            ...
                            <figure class="category-header-info">
                                <h2 class="category-header-heading">Music</h2>
                                <p class="category-header-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores soluta voluptas repellendus harum, ipsam necessitatibus suscipit vel aliquid ea temporibus qui culpa dolore iusto, amet aut at pariatur consequatur fugit?</p>
                            </figure>
                        </figure>
                                ...
                                <form class="category-filter-form" action="talent-list.php">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="block-half normalize-selectize">
                                            <select id="selectCountry" data-countries="dev/countries.json" ng-model="filterCountry" ng-options="country.value as country.name for country in countries track by country.value" ng-change="getCitiesByCountry()"></select>
                                        </div>

                                        <div class="block-half normalize-selectize">
                                            <select id="selectCity" ng-model="filterCities" ng-options="city.value as city.name for city in cities track by city.value" ng-disabled="isGettingCities"></select>
                                        </div>
                                    </fieldset>
