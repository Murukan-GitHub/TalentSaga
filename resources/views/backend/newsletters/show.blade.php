            ...
            <div class="portlet-body form">
                <div class="row">
                    ...
                    <div class="col-lg-9 form-horizontal form-bordered form-row-stripped">
                        ...
                        @if(!in_array($key, $baseObject->getHidden()) && (!$baseObject->timestamps || !in_array($key, $baseObject->timestampFields)) && !in_array($key, ['id', 'banner_top_image', 'banner_top_url', 'banner_top_title', 'email_body', 'banner_bottom_image', 'banner_bottom_url', 'banner_bottom_title']))
                        ...
                        <div class="form-group clearfix">
                            <div class="col-md-12">
                            	<h4>Preview</h4>
                                <iframe src="{{ route('backend.newsletter.preview', ['id' => $baseObject->id]) }}" style="width: 100%; height: 500px;"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
