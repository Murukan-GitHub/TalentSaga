...
;(function ( w, d, undefined ) {
    ...
    var SuitmediaHelper = {
        chartOpts       : ChartOpts,
        isImage         : Suitmedia.isImage,
        isPDF           : Suitmedia.isPDF,
        isDOC           : Suitmedia.isDOC,
        isXLS           : Suitmedia.isXLS,
        isPPT           : Suitmedia.isPPT,
        supportFileAPI  : Suitmedia.supportFileAPI,
        getUID          : Suitmedia.getUID,
        changeTableData : Suitmedia.changeTableData
    };

    w.SuitmediaHelper = SuitmediaHelper;
})( window, document );
