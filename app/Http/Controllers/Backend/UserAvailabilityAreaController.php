...
class UserAvailabilityAreaController extends BackendController
{
    /**
     * Override Default Constructor.
     *
     * @param UserAvailabilityAreaRepository $_baseRepo
     * @param UserAvailabilityArea           $_baseModel
     */
    public function __construct(UserAvailabilityAreaRepository $_baseRepo, UserAvailabilityArea $_baseModel)
    {
        parent::__construct($_baseRepo, $_baseModel, 'user');
        $this->routeBaseName = 'backend.useravailabilityarea';
        $this->viewBaseClosure = 'backend.useravailabilityareas';
