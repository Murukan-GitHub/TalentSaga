                ...
                <section class="hero" style="background-image: url(<?php echo e(asset('frontend/assets/img/landing-page-bg.jpg')); ?>);">
                    <div class="hero-content">
                        <div class="text-center">
                            <h2><?php echo e(trans('notification.pagenotfoundtitle')); ?></h2>
                            <?php echo e(trans('notification.pagenotfoundcontent')); ?> 
                        </div>
    ...
    <?php if(!session()->get('accept-cookie', false)): ?>
        <div id="cookie-notice">
            <div id="cookie-notice-container">
                <span id="cookie-notice-text">We use cookies to ensure that we give you the best experience on our website. If you continue to use this site we will assume that you are happy with it.</span><a href="<?php echo e(route('frontend.home.acceptcookie')); ?>" class="btn btn--tosca">OK</a>
            </div>
        </div>
    <?php endif; ?>
