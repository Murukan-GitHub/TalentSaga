    ...
    var Site = {
        ...
        datatableYadcf: function () {
            ...
            $.each($tables, function (index, table) {
                ...
                $('input.yadcf-filter-date').addClass('form-input');
        ...
        chart: function () {
            ...
            function generateChart( elem, type, opts ) {
                ...
                var currentOpts = $.extend(true, PHE.chartOpts[type], {});
        ...
        changeTableData: function () {
            ...
            $select.on('change', function() {
                ...
                PHE.changeTableData( dataURL, $target );
            });
        },
        ...
        selectAutocomplete: function () {
            ...
            $.each($selects, function(index, select) {
                var data = select.getAttribute('data-select-autocomplete') || null;

                if ( data ) {
                    $.getJSON(data, function(result, textStatus) {
                        $(select).select2({
                            data: result.data
                        });
                    });
        ...
        inputBrowseFiles: function () {
            ...
            function createAttachedList( files ) {
                ...
                for (var i = 0; i < files.length; i++) {
                    ...
                    if ( PHE.isImage( current.name ) ) {
                        result += 'fa-file-image-o';
                    } else if ( PHE.isPDF( current.name ) ) {
                        result += 'fa-file-pdf-o';
                    } else if ( PHE.isDOC( current.name ) ) {
                        result += 'fa-file-word-o';
                    } else if ( PHE.isPPT( current.name ) ) {
                        result += 'fa-file-powerpoint-o';
                    } else if ( PHE.isXLS( current.name ) ) {
        ...
        executionDocList: function () {
            ...
            var createNewExecDoc = function (e) {
                ...
                var selectCheckboxID    = PHE.getUID();
