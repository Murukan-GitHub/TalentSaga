...
@section('content')
    <div class="site-main-inner-padded">
        <div class="container">
            ...
            {!!Form::open(['route' => 'user.onboarding.personal.save', 'class' => 'form-baa', 'data-validate'])!!}
                <fieldset>
                    <legend class="text-center h3 text-caps">{{ trans('label.data_personal.title') }}</legend>
